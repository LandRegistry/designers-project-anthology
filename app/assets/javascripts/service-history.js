...
(function (Modules) {
  ...
  Modules.ServiceHistory = function () {
      ...
      function addShowHideToggle () {
        $stepHeaders.each(function () {
          ...
          if (!$(this).find('.js-toggle-link').length) {
            $(this).find('.app-step-nav__title').append('<span class="app-step-nav__toggle-link js-toggle-link" aria-hidden="true">' + linkText + '</span>')
          }
        })
      }
